    ...
    This package is a work in progress.
       ...
       Description:
    Meta Achievements is a simple component that allows creators to add player based Achievements 
    
    
    Setup
    =====

    1. To begin first drag the "Achievement System" into your hierarchy.
