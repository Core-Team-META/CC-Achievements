...
Interested in contributing to CC-Achievements? Want to report a bug?
...
[2]: https://github.com/Core-Team-META/CC-Achievements
...
3. **Pull Request**: After making sure everything passes, commit your changes,
   push your branch to GitHub and send a PR to `Core-Team-META/CC-Achievements:main`.
